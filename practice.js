...
// var s_gate = {
// 		location: map[x][y],
// 		description: "<p>You are now at the Southern Gate of the Castle grounds. You see a glint of light obscured in the soil and crouch towards it, wiping away the leaves and earth to find ... a sword!</p>",
// 		tool: "Sword"
// 	}

// var s_west = {
// 	location: map[x][y],
// 	description: "<p>You are now at the southwestern corner of this world. The sun catches the surface of a small, ornamented mirror on your path.</p>",
// 	tool: "Mirror"
// }
...
// function pickUp(inventoryItem) {
// 	newPlayer.inventory.push(inventoryItem);
// 	updateInventory();
//  $(inventoryItem.message).insertBefore("#placeholder");
// }
